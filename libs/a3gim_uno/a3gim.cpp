...
#endif
	// Constants for pins
#define	IEM_RXD_PIN			7		// D4(For example,If you use Leonardo or Mega etc. then change to D10..) teensy 7 
#define	IEM_TXD_PIN			8		// D5(For example,If you use Leonardo or Mega etc. then change to D11..) teensy 8  
...
#else
//static char gWorkBuffer[128];		// Buffer for working(UNO..)
static char gWorkBuffer[256];		// Buffer for working(UNO..)
#endif
